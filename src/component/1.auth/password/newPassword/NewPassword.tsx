...
import {createNewPassword} from "../password-restore-reducer";

const NewPassword = () => {
  const dispatch = useDispatch()
  const changingPasswordSuccess = useSelector<AppRootStateType, boolean>(state => state.password.changingPasswordSuccess)
